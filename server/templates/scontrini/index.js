...
function tableTest(scontrino) {
  return veloci.table(scontrino, {
    columns: [
      { name: "test", value: "_id" },
      {
        name: "minimo",
        value: veloci.min("righe", "prezzoUnitario", veloci.compareNumbers),
      },
      {
        name: "massimo",
        value: veloci.max("righe", "prezzoUnitario", veloci.compareNumbers),
      },
      {
        name: "somma",
